...
//!
//! This module provides the [`Zero`] and [`One`] traits, which are used to represent the identity
//! elements of a scalar type.
//!
//! These traits are extraneous to the [`Scalar`] trait, but are provided for convenience when
//! needed.
