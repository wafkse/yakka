...
//!
//! This module exposes various structures to represent each of the gain factors of a PID controller.
...
///
/// This is a transparent wrapper over the underlying scalar, therefore the use of this structure is only useful to tag the data with its associated use case.
