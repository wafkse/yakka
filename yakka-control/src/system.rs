//! Various structures for representing the state of a control system, be it closed-loop or open-loop.

use core::ops::{Deref, DerefMut};

use yakka_number::{prelude::Zero, scalar::Scalar};

/// A trait that represents a control system of any kind: closed-loop or open-loop, and that operates on scalar values of type `T`
///
/// For open-loop control systems, an unit [context] can be used. Use the [`Control::cycle`] method to perform a control cycle.
///
