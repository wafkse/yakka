...
///
/// This structure contains both linear and angular motion data. Aditionally, it can be used to
/// update the state of the aircraft based on a time difference `dt`, and the current state of the
/// aircraft.
